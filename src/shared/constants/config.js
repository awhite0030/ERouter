...
export const APP_CONFIG = {
  name: "ERouter",
  description: "AI router & token saver for coding tools",
  version: pkg.version,
};
...
export const UPDATER_CONFIG = {
  npmPackageName: "erouter",
  installCmd: "npm i -g erouter",
  installCmdLatest: "npm i -g erouter@latest --prefer-online",
