...
Integrate ERouter with OpenAI Codex CLI to route your OpenAI API requests through ERouter's intelligent routing system.
...
ERouter provides the following Codex models:
...
1. Verify your API key is correct in ERouter dashboard
...
1. Verify the model name matches your ERouter configuration
2. Check that the OpenAI provider connection is active in ERouter dashboard
...
Make sure you have configured your API key in the ERouter cloud dashboard.
