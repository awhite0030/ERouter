...
Hướng dẫn cài đặt chi tiết cho ERouter với mẹo troubleshooting.
...
Cài ERouter toàn cục để dùng ở bất kỳ đâu:
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `erouter`
- ✅ Auto-update với `npm update -g erouter`
...
3. Data directory được tạo tại `~/.erouter`
...
**Vấn đề:** ERouter dùng quá nhiều RAM
