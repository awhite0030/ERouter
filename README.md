<div align="center">
  <img src="./images/erouter.png?1" alt="ERouter Dashboard" width="800"/>
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [![GHCR](https://img.shields.io/badge/GHCR-awhite0030%2FERouter-blue?logo=github)](https://github.com/awhite0030/ERouter/pkgs/container/erouter)
  [![License](https://img.shields.io/npm/l/erouter.svg)](https://github.com/awhite0030/ERouter/blob/main/LICENSE)

[🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://github.com/awhite0030/ERouter)
...
This repository package is private (`erouter-app`), so source/Docker execution is the expected local development path.
...
<table>
  ...
  <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
    <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với ERouter" width="300"/>
  </a><br/>
  <b>🇻🇳 Tiếng Việt</b><br/>
  <sub>Tiết kiệm chi phí LLM cho OpenClaw với ERouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
</td>
<td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="ERouter + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>ERouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="ERouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>ERouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="ERouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>ERouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    ...
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with ERouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
  ...
  <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + ERouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup ERouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  ...
  <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy ERouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy ERouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
...
> 🎬 **Made a video about ERouter?** Submit a [Pull Request](https://github.com/awhite0030/ERouter/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

ERouter works seamlessly with all major AI coding tools:
...
Headroom is optional and runs separately. ERouter calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → ERouter → Headroom /v1/compress → ERouter → provider
```
...
If Headroom is down or returns an error, ERouter fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → ERouter translates → Provider receives native format
...
> ERouter itself **never charges** you anything. You only pay providers directly (if using paid services).
>
...
### 📊 Understanding ERouter Costs & Billing

**ERouter Billing Reality:**

✅ **ERouter software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **ERouter never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, ERouter just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **ERouter**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through ERouter.
...
<details>
<summary><b>💳 Will I be charged by ERouter?</b></summary>

**No.** ERouter is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**

- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, ERouter just routes your requests
- ❌ **ERouter itself** → **Never charges anything, ever**

ERouter is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
ERouter just routes your requests to them - there's no "catch" or future billing. They're truly free services, and ERouter makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - ERouter helps maximize their value through quota tracking
...
ERouter's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and ERouter respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. ERouter tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from erouter dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-erouter-api-key"
}
```
...
export OPENAI_API_KEY="your-erouter-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "erouter/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local ERouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
export DATA_DIR="/var/lib/erouter"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://github.com/awhite0030/ERouter"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name erouter -- start
pm2 save
pm2 startup
```
...
- Docker Hub: [`awhite0030/ERouter`](https://hub.docker.com/r/awhite0030/ERouter)
- GHCR: [`ghcr.io/awhite0030/ERouter`](https://github.com/awhite0030/ERouter/pkgs/container/erouter)
...
docker run -d --name erouter -p 20128:20128 \
  -v "$HOME/.erouter:/app/data" -e DATA_DIR=/app/data erouter
```
...
```bash
docker logs -f erouter
docker restart erouter
docker stop erouter && docker rm erouter
docker pull awhite0030/ERouter:latest   # update to latest
```

**Data persistence:** `$HOME/.erouter/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable                                             | Default                                  | Description                                                                         |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | Auto-generated (`~/.erouter/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances)   |
| `INITIAL_PASSWORD`                                   | `123456`                                 | First login password when no saved hash exists                                      |
| `DATA_DIR`                                           | `~/.erouter`                             | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`)                       |
| `PORT`                                               | framework default                        | Service port (`20128` in examples)                                                  |
| `HOSTNAME`                                           | framework default                        | Bind host (Docker defaults to `0.0.0.0`)                                            |
| `NODE_ENV`                                           | runtime default                          | Set `production` for deploy                                                         |
| `BASE_URL`                                           | `http://localhost:20128`                 | Server-side internal base URL used by cloud sync jobs                               |
| `CLOUD_URL`                                          | `https://github.com/awhite0030/ERouter`                    | Server-side cloud sync endpoint base URL                                            |
| `NEXT_PUBLIC_BASE_URL`                               | `http://localhost:3000`                  | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime)          |
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://github.com/awhite0030/ERouter`                    | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime)        |
...
- Both `${DATA_DIR}` and `~/.erouter` resolve to the same location in a Docker container — the symlink `/root/.erouter -> /app/data` is created at build time.
...
- **Website**: [erouter.com](https://github.com/awhite0030/ERouter)
- **GitHub**: [github.com/awhite0030/ERouter](https://github.com/awhite0030/ERouter)
- **Issues**: [github.com/awhite0030/ERouter/issues](https://github.com/awhite0030/ERouter/issues)

---

## 👥 Contributors

Thanks to all contributors who helped make ERouter better!

[![Contributors](https://contrib.rocks/image?repo=awhite0030/ERouter&max=150&columns=15&anon=1&v=20260309)](https://github.com/awhite0030/ERouter/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/awhite0030/ERouter.svg?variant=adaptive)](https://starchart.cc/awhite0030/ERouter)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of ERouter. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. ERouter ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. ERouter adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — _"lazy senior dev"_ skill. ERouter injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, ERouter's token-saving features wouldn't exist. ⭐ them on GitHub!
