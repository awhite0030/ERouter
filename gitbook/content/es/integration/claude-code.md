...
Integra ERouter con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de ERouter.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de ERouter:
...
```bash
export ANTHROPIC_BASE_URL="https://github.com/awhite0030/ERouter"
```
