...
ERouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

ERouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a ERouter usando estas configuraciones:

**ERouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de ERouter (cc/*, cx/*, glm/*, etc.)
```

**ERouter en la nube:**
```
Base URL: https://github.com/awhite0030/ERouter/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de ERouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a ERouter
```bash
# Verifica si ERouter está corriendo
...
**Solución:**
- Verifica que ERouter esté corriendo
...
- Verifica la conexión de red a ERouter
