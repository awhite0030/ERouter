...
export const metadata = {
  title: "ERouter — AI Router & Token Saver",
  description: "One OpenAI-compatible endpoint for all AI providers. Fallback, token saver, combos, and usage analytics for coding tools.",
  icons: {
    icon: "/favicon.svg",
  },
};
