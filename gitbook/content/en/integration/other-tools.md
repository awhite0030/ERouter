...
ERouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

ERouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to ERouter using these settings:

**Local ERouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any ERouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to ERouter
```bash
...
- Check network connection to ERouter
