...
Integra ERouter con la extensión Cline de VSCode para enrutar tus solicitudes de IA a través del sistema de enrutamiento inteligente de ERouter.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Cline instalada desde el marketplace de VSCode
- ERouter ejecutándose localmente o endpoint en la nube configurado
...
Establece la URL base a tu endpoint de ERouter:
...
**Para ERouter en la nube:**
```
https://github.com/awhite0030/ERouter
```

**Pasos:**
1. En el campo **Base URL**, ingresa tu endpoint de ERouter
...
4. Cline usará ERouter para procesar tu solicitud

### Generación de código

1. Pide a Cline que genere código: "Create a React component for a login form"
2. Cline generará código usando ERouter
...
3. Obtén explicaciones potenciadas por IA a través de ERouter

### Operaciones con archivos

1. Pide a Cline que cree, modifique o elimine archivos
2. Cline usará ERouter para entender el contexto y hacer cambios
...
1. Verifica que ERouter esté corriendo: `curl http://localhost:20128/health`
...
2. Verifica que tu instancia de ERouter esté ejecutándose y saludable
3. Intenta recargar la ventana de VSCode (Cmd/Ctrl + Shift + P → "Reload Window")
4. Revisa los logs de ERouter para cualquier error

## Configuración avanzada

### Usar endpoint en la nube

Para usar el endpoint en la nube de ERouter en lugar de localhost:

1. En la configuración de Cline, establece Base URL a: `https://github.com/awhite0030/ERouter`
2. Asegúrate de haber configurado tu API key en el dashboard en la nube de ERouter
...
## Integración con características de ERouter

### Enrutamiento de modelos

ERouter enruta automáticamente tus solicitudes al mejor proveedor disponible según:
...
Si un proveedor falla, ERouter automáticamente cambia a proveedores alternativos configurados en tu dashboard.

### Seguimiento de uso

Monitorea tu uso de Cline a través del dashboard de ERouter:
