...
Common questions about ERouter.

---

## What is ERouter?

**ERouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**ERouter uses a 3-tier pricing strategy:**
...
**Yes, ERouter itself is 100% free and open source.**
...
**Yes! This is ERouter's core feature.**
...
**ERouter tracks quota in real-time for all providers:**
...
## Can I self-host ERouter?

**Yes! ERouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.erouter`)
...
**Yes, ERouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.erouter` (or custom `DATA_DIR`)
- No data sent to ERouter servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/awhite0030/ERouter/blob/main/CHANGELOG.md)
- Backup `~/.erouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/awhite0030/ERouter/blob/main/CONTRIBUTING.md) for details.
