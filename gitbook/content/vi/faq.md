...
Những câu hỏi phổ biến về ERouter.

---

## ERouter là gì?

**ERouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**ERouter dùng chiến lược pricing 3 tầng:**
...
## ERouter có miễn phí không?

**Có, ERouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của ERouter.**
...
**ERouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host ERouter không?

**Có! ERouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.erouter`)
...
**Có, ERouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.erouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server ERouter
...
## Làm thế nào để cập nhật ERouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/awhite0030/ERouter/blob/main/CHANGELOG.md)
- Backup `~/.erouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/awhite0030/ERouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [erouter.com/docs](https://github.com/awhite0030/ERouter/docs)
