...
Integrate ERouter with Claude Code CLI to route your Anthropic API requests through ERouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to ERouter models:
