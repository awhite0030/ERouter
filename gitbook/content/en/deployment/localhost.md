...
Run ERouter on your local machine for development and personal use.

---

## 📦 Installation

Install ERouter globally via npm:
...
Start ERouter with a single command:
...
Press `Ctrl+C` in the terminal where ERouter is running.

```bash
# In the terminal running erouter
^C  # Press Ctrl+C
```
