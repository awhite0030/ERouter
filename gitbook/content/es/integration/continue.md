...
Integra ERouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de ERouter desde el [dashboard](https://github.com/awhite0030/ERouter/dashboard)
- ERouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de ERouter
...
```json
{
  "models": [
    {
      "title": "ERouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "ERouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "ERouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "ERouter - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://github.com/awhite0030/ERouter/v1"
```
...
3. Elige tu modelo preferido de ERouter
...
- Verifica que ERouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de ERouter
...
- Verifica la latencia de red hacia ERouter
