...
const cliAppDir = process.env.EROUTER_CLI_APP_DIR || process.env.NINEROUTER_CLI_APP_DIR || path.join(cliDir, "app");
...
console.log("📦 Building ERouter CLI package with Next.js...\n");
...
// e.g. .next-cli-build/standalone/erouter/server.js
...
// Strip better-sqlite3 (native) — it lives in ~/.erouter/runtime to avoid
...
if (fs.existsSync(betterDir)) {
  ...
  console.log("✅ Stripped better-sqlite3 (lives in ~/.erouter/runtime)");
}
console.log("");
