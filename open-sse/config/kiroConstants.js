 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what erouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a erouter
...
/**
 * Detect whether a model id refers to a erouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a erouter synthetic thinking variant
...
/**
 * Resolve a erouter model id to the real upstream Kiro model id, plus flags
