 ...
 * API. They are erouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic erouter variant set for a single upstream Kiro model.
 *
 ...
 * into erouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
