...
Detailed installation guide for ERouter with troubleshooting tips.
...
Install ERouter globally to use from anywhere:
...
- ✅ Simple command: `erouter`
- ✅ Auto-updates with `npm update -g erouter`
...
3. Data directory created at `~/.erouter`
...
**Issue:** ERouter using too much RAM
...
# Delete erouter-related exports
```
