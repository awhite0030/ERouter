...
Tích hợp ERouter với Claude Code CLI để định tuyến request API Anthropic qua hệ thống routing thông minh của ERouter.
...
Claude Code hỗ trợ các alias model sau ánh xạ sang model ERouter:
