...
Preguntas comunes sobre ERouter.

---

## ¿Qué es ERouter?

**ERouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**ERouter usa una estrategia de precios de 3 niveles:**
...
**Sí, ERouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de ERouter.**
...
**ERouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿ERouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de ERouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://github.com/awhite0030/ERouter/v1
...
## ¿Puedo auto-hospedar ERouter?

**¡Sí! ERouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.erouter`)
...
**Sí, ERouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.erouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de ERouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/awhite0030/ERouter/blob/main/CHANGELOG.md)
- Respalda `~/.erouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/awhite0030/ERouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/awhite0030/ERouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/erouter.git
   cd erouter
...
Consulta [CONTRIBUTING.md](https://github.com/awhite0030/ERouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [erouter.com/docs](https://github.com/awhite0030/ERouter/docs)
