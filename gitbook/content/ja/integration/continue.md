...
ERouterをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://github.com/awhite0030/ERouter/dashboard)からのERouter APIキー
- ERouterが動作中 (ローカルまたはクラウド)
...
### モデルが応答しない
- ERouterが動作中か確認: `curl http://localhost:20128/health`
