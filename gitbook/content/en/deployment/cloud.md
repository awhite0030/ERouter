...
Deploy ERouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.erouter` | Database and data storage path |
...
Create `/etc/nginx/sites-available/erouter`:
