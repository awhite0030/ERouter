...
将 ERouter 与 Continue 扩展集成,直接在 Visual Studio Code 中获得 AI 协助。

## 前置要求

- 已安装 Visual Studio Code
- 从 VSCode 市场安装了 Continue 扩展
- 来自 [仪表盘](https://github.com/awhite0030/ERouter/dashboard) 的 ERouter API key
- ERouter 正在运行(本地或云端)
...
### 模型无响应
- 确认 ERouter 正在运行:`curl http://localhost:20128/health`
