...
Integrate ERouter with Cline VSCode extension to route your AI requests through ERouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- ERouter running locally or cloud endpoint configured
...
Set the base URL to your ERouter endpoint:
...
**Steps:**
1. In the **Base URL** field, enter your ERouter endpoint
...
3. The key should start with `sk-erouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your ERouter configuration
...
4. Cline will use ERouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using ERouter
...
3. Get AI-powered explanations through ERouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use ERouter to understand context and make changes
...
1. Verify ERouter is running: `curl http://localhost:20128/health`
...
2. Verify your ERouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check ERouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use ERouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://github.com/awhite0030/ERouter`
2. Make sure you have configured your API key in the ERouter cloud dashboard
...
## Integration with ERouter Features

### Model Routing

ERouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, ERouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through ERouter dashboard:
- Total requests
- Token usage
- Cost per model
