...
Integra ERouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de ERouter.
...
ERouter proporciona los siguientes modelos de Codex:
...
1. Verifica que tu API key sea correcta en el dashboard de ERouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de ERouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de ERouter
...
```bash
export OPENAI_BASE_URL="https://github.com/awhite0030/ERouter"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de ERouter.
