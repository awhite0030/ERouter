...
ERouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをERouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはERouterモデルにマッピングされる以下のモデルエイリアスをサポート:
