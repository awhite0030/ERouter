...
const APP_NAME = "erouter";
const APP_LABEL = "com.erouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when erouter is currently
 ...
 * SIGTERM to the running process. When the running erouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/erouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/erouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `erouter.cmd` lookup that depended on the npm prefix path.
