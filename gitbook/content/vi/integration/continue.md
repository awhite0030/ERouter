...
Tích hợp ERouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- ERouter API key từ [dashboard](https://github.com/awhite0030/ERouter/dashboard)
- ERouter đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra ERouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến ERouter
