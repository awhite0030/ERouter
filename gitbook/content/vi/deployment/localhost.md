...
Chạy ERouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt ERouter toàn cục qua npm:
...
Khởi động ERouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy ERouter.
