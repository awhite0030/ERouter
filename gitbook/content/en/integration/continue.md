...
Integrate ERouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- ERouter API key from [dashboard](https://github.com/awhite0030/ERouter/dashboard)
- ERouter running (local or cloud)
...
### 2. Add ERouter Model Configuration
...
3. Choose your preferred ERouter model
...
- Check network latency to ERouter
