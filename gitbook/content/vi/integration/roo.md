...
Tích hợp ERouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model ERouter có sẵn:
...
### Connection Failed
- Xác minh ERouter đang chạy: `curl http://localhost:20128/health`
