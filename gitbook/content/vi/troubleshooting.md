...
Các vấn đề và giải pháp phổ biến khi dùng ERouter.
...
1. **Auto-refresh (mặc định):**
   ERouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
1. **Kiểm tra ERouter có chạy không:**
   ```bash
   # Check process
   ps aux | grep erouter
