...
Guía detallada de instalación de ERouter con consejos de solución de problemas.
...
Instala ERouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `erouter`
- ✅ Auto-actualizaciones con `npm update -g erouter`
...
3. Se crea el directorio de datos en `~/.erouter`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/erouter'
```
...
**Problema:** ERouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start erouter --name erouter
pm2 save
```
...
```bash
docker pull erouter/erouter:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v erouter-data:/root/.erouter \
  --name erouter \
  erouter/erouter:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con erouter
```
...
- **Sitio web**: [erouter.com](https://github.com/awhite0030/ERouter)
