...
// Build TOML config for ERouter (openai provider mode)
const buildERouterConfig = (baseUrl, apiKey, model) => {
...
// Detect ERouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildERouterConfig(baseUrl, apiKey || "sk_erouter", model);
